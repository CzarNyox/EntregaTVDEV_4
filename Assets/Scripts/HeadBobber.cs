...
public class HeadBobber : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (waveslice != 0f)
        {
            ...
            targetPos.Set(transform.localPosition.x, endpoint + translateChange, transform.localPosition.z);
        }
        else
        {
            targetPos.Set(transform.localPosition.x, endpoint, transform.localPosition.z);
        }
