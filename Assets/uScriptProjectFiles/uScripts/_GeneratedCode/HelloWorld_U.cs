...
public class HelloWorld_U : uScriptLogic
{
   ...
   //local nodes
   [Multiline(3)]
   public System.String strHW = "Hello World!";
   ...
   void Relay_In_0()
   {
      ...
      {
         if (true == CheckDebugBreak("a6169bdb-cfde-43af-be33-3d6c6e288a5b", "Print_String_List", Relay_In_0)) return; 
         {
            {
               int index = 0;
               if ( logic_uScriptAct_PrintList_Strings_0.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_PrintList_Strings_0, index + 1);
               }
               logic_uScriptAct_PrintList_Strings_0[ index++ ] = strHW;
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript HelloWorld_U.uscript at Print String List.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   
   void Relay_OnUpdate_2()
   {
      if (true == CheckDebugBreak("02330c27-6533-4b30-971e-fd1619f60796", "Global_Update", Relay_OnUpdate_2)) return; 
      Relay_In_0();
   }
   
   void Relay_OnLateUpdate_2()
   {
      if (true == CheckDebugBreak("02330c27-6533-4b30-971e-fd1619f60796", "Global_Update", Relay_OnLateUpdate_2)) return; 
   }
   
   void Relay_OnFixedUpdate_2()
   {
      if (true == CheckDebugBreak("02330c27-6533-4b30-971e-fd1619f60796", "Global_Update", Relay_OnFixedUpdate_2)) return; 
   }
   
   private void UpdateEditorValues( )
   {
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "HelloWorld_U.uscript:strHW", strHW);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "6dac1a68-0828-4fd1-863e-bd5d1b9fdfc0", strHW);
   }
